...
CREATE TABLE usuario (
                         ...
                         CONSTRAINT usuario_role_chk CHECK (role IN ('USER', 'ADMIN')),
...
BEGIN
    ...
    IF v_exists = 0 THEN
        INSERT INTO usuario(id_usuario, nome, cpf_cnpj, email, senha, role, ativo)
        VALUES (99999, 'USUARIO GENERICO', '00000000000000', 'generico@example.com', '***', 'USER', 'S');
    END IF;
...
BEGIN
    ...
    INSERT INTO vendas(id_vendas, usuario_id_usuario, reg_cont_id_reg_cont, venda_evento_id_evento)
    VALUES (v_venda_id, v_usuario, v_reg_cont_id, :NEW.id_evento);
